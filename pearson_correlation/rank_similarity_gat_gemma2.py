...
# train_word_list, train_graph_list, train_protein_id = create_representation_lists(train_ids, protein_representations_gat, protein_representations_gemma2)
# val_word_list, val_graph_list, val_protein_id = create_representation_lists(val_ids, protein_representations_gat, protein_representations_gemma2)
test_word_list, test_graph_list, test_protein_id = create_representation_lists(test_ids, protein_representations_gat, protein_representations_gemma2)
...
with open('../workspace_data/similarity_scores_gat_gemma2.json', 'w') as json_file:
