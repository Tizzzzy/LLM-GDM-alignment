...
# protein_proj_head.load_state_dict(torch.load('../workspace_data/best_protein_proj_head_gvp_gemma2_2layer.pth'))
# token_proj_head.load_state_dict(torch.load('../workspace_data/best_token_proj_head_gvp_gemma2_2layer.pth'))
