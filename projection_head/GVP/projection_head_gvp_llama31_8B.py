...
protein_proj_head = ProteinProjectionHead(input_dim=148, output_dim=4096).to(device)
...
for epoch in range(num_epochs):
    ...
    if val_loss.item() < best_val_loss:
        torch.save(protein_proj_head.state_dict(), '../workspace_data/best_protein_proj_head_gvp_llama31_8B.pth')
        torch.save(token_proj_head.state_dict(), '../workspace_data/best_token_proj_head_gvp_llama31_8B.pth')
...
protein_proj_head.load_state_dict(torch.load('../workspace_data/best_protein_proj_head_gvp_llama31_8B.pth'))
token_proj_head.load_state_dict(torch.load('../workspace_data/best_token_proj_head_gvp_llama31_8B.pth'))
