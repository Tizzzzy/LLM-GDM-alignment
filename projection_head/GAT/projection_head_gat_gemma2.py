...
for epoch in range(num_epochs):
    ...
    if val_loss.item() < best_val_loss:
        torch.save(protein_proj_head.state_dict(), '../workspace_data/best_protein_proj_head_gat_gemma2.pth')
        torch.save(token_proj_head.state_dict(), '../workspace_data/best_token_proj_head_gat_gemma2.pth')
