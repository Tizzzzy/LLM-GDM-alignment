...
# protein_proj_head = ProteinProjectionHead(input_dim=128, hidden_dim=1024, output_dim=2304).to(device)
protein_proj_head = ProteinProjectionHead(input_dim=128, hidden_dim1=512, hidden_dim2=1024, output_dim=2304).to(device)
...
for epoch in range(num_epochs):
    ...
    if val_loss.item() < best_val_loss:
        # torch.save(protein_proj_head.state_dict(), '../workspace_data/best_protein_proj_head_scannet_gemma2_2layer.pth')
        # torch.save(token_proj_head.state_dict(), '../workspace_data/best_token_proj_head_scannet_gemma2_2layer.pth')
        torch.save(protein_proj_head.state_dict(), '../workspace_data/best_protein_proj_head_scannet_gemma2_3layer.pth')
        torch.save(token_proj_head.state_dict(), '../workspace_data/best_token_proj_head_scannet_gemma2_3layer.pth')
...
# protein_proj_head.load_state_dict(torch.load('../workspace_data/best_protein_proj_head_scannet_gemma2_2layer.pth'))
# token_proj_head.load_state_dict(torch.load('../workspace_data/best_token_proj_head_scannet_gemma2_2layer.pth'))
protein_proj_head.load_state_dict(torch.load('../workspace_data/best_protein_proj_head_scannet_gemma2_3layer.pth'))
token_proj_head.load_state_dict(torch.load('../workspace_data/best_token_proj_head_scannet_gemma2_3layer.pth'))
