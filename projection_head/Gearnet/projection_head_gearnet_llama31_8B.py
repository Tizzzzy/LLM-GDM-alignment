...
with open("../llama31_8B/protein_representations_llama31.json", "r") as json_file:
...
protein_proj_head = ProteinProjectionHead(input_dim=3072, output_dim=4096).to(device)
token_proj_head = TokenProjectionHead(input_dim=4096, output_dim=4096).to(device)
...
for epoch in range(num_epochs):
    ...
    if val_loss.item() < best_val_loss:
        torch.save(protein_proj_head.state_dict(), '../workspace_data/best_protein_proj_head_gearnet_llama31_8B.pth')
        torch.save(token_proj_head.state_dict(), '../workspace_data/best_token_proj_head_gearnet_llama31_8B.pth')
...
protein_proj_head.load_state_dict(torch.load('../workspace_data/best_protein_proj_head_gearnet_llama31_8B.pth'))
token_proj_head.load_state_dict(torch.load('../workspace_data/best_token_proj_head_gearnet_llama31_8B.pth'))
